...
from dtfb.imaging.compose import render_spin_video
from dtfb.imaging.compose.spin import DEFAULT_CANVAS_SIZE, MIN_ANCHORS
...
def main():
    ...
    parser.add_argument("vehicle_folder", help="A folder produced by dtfb.py (contains images/exterior/cutout/)")
