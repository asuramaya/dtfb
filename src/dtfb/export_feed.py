...
dtfb, in the shape third-party listing platforms (Meta/Facebook
...
what this does: dtfb already has everything a feed needs (VIN, price,
...
Usage:
    from dtfb.export_feed import build_rows, write_csv
...
# condition (dtfb's own scraped value) -> state_of_vehicle (feed value).
...
def vehicle_to_row(folder: Path) -> dict | None:
    ...
    row = {
        ...
        # characters; 2000 is a conservative slice of dtfb's own
